...
import framework.GameChangeListener;
import framework.GameFrameworkImpl;
import framework.GamePlugin;
import framework.Player;

/**
 * The framework GUI implementation. 
 * This class is responsible for displaying the framework GUI to the screen
 */
public class GameFrameworkGui implements GameChangeListener {
    ...
    public void onNewGame(GamePlugin plugin) {
        ...
        if (currentPlugin != plugin) {
            // If currentPlugin != plugin, then we are switching to a new one
